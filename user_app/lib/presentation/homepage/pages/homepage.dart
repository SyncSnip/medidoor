...
import 'package:user_app/presentation/product_details_page/pages/product_details_page.dart';
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(
                      // image: AssetImage(AppImages.vicksVaporub),
                      image: Image.network(productModel.prodType.image).image,
                      fit: BoxFit.cover),
                  borderRadius:
